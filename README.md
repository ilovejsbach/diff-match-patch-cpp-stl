...
[![Build Status](https://travis-ci.org/ilovejsbach/diff-match-patch-cpp-stl.png)](https://travis-ci.org/ilovejsbach/diff-match-patch-cpp-stl)

C++ STL variant of https://code.google.com/p/google-diff-match-patch.

STL Port was done by Sergey Nozhenko (ilovejsbach@gmail.com) and posted on
